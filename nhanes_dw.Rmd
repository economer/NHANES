...
The links to the location of the files were identified above. However, if we need to download the the datasets we are required to takes a few more steps. One can use the codes below to download the all the files based on the data type (e.g. examination or demographic) and files. 
...
Replacing the variable names to their labels, can be done using the codes below. The same procedure as section 2.2. is followed here.  
...
## 2.4.1. Names repair examination file
